# Resources list - built by you!

## CSS
- [Bootstrap itself](https://getbootstrap.com/docs/5.2/getting-started/introduction/)
- [Bootstrap Cheatsheet](https://bootstrap-cheatsheet.themeselection.com/)
- [Bootstrap background images](https://toruskit.com/docs/utilities/background-image/)
...
- [More CSS tricks](https://css-tricks.com/almanac/)
...
- [Fancy Redux](https://redux.js.org/tutorials/fundamentals/part-5-ui-react#presentational-and-container-components)
- [MongoDB CheatSheet](https://www.mongodb.com/developer/products/mongodb/cheat-sheet/)
- [Node.js documentation](https://nodejs.org/api/assert.html)
...
## MySQL
- [MySQL practice](https://www.sql-practice.com/)
...
- [Python tutor for testing code](https://pythontutor.com)
...
- [Need an idea for an app?  Here's an API idea generator!](https://appideagenerator.com/)
...
## Videos
- [Building a clock in JS](https://www.youtube.com/watch?v=Ki0XXrlKlHY)
- [Chat app with socket.io tutorial AND login/reg](https://www.youtube.com/watch?v=3vRcB0P84t4&list=PLKhlp2qtUcSZsGkxAdgnPcHioRr-4guZf)
...
- [ZenHub (part of GitHub)](https://www.zenhub.com)

## Algorithms
- [LeetCode](https://leetcode.com)
- [Blind 75 LeetCode questions](https://leetcode.com/discuss/general-discussion/460599/blind-75-leetcode-questions)
- [More data structures and algorithms](https://techdevguide.withgoogle.com/paths/data-structures-and-algorithms/?no-filter=true)
